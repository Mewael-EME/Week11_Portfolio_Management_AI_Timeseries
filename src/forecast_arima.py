...
def train_arima(data_path: str, train_end="2023-12-31"):
    """
    Train and evaluate an ARIMA model for Tesla stock price forecasting.
    ...
    # Find split index for train/test based on train_end date
